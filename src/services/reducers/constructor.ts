import { GET_CHOSEN_ITEMS, SET_TOTAL_PRICE, DELETE_ITEM, MOVE_ITEM, CLEAR_CONSTRUCTOR } from '../constants/constructor';
import { TCnstrActions, IGetChosenItemsAction } from '../actions/constructor';
import { TIngr } from '../../types';

type TCnstrState = {
    chosenItems: ReadonlyArray<TIngr>,
    price: number
}

const initialState: TCnstrState = {
    chosenItems: [],
    price: 0
}
